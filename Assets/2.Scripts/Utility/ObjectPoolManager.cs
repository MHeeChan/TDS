...
public class ObjectPoolManager : MonoBehaviour
{
    ...
    public GameObject GetGo(string goName, Vector2 direction) {
        objectName = goName;
        ...
        GameObject obj = ojbectPoolDic[goName].Get();

        // 방향 설정
        PoolAble poolAbleObj = obj.GetComponent<PoolAble>();
        
        if (poolAbleObj != null) {
            poolAbleObj.SetDirection(direction);
        }
